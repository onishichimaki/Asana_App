...
- [x] 47. ログインせず通常入力とWBS画面を操作できるクライアント内画面確認モードを追加する
- [x] 48. 画面確認モードから業務API、Asana登録、履歴、利用者設定を利用できない状態を維持する
- [x] 49. 固定Releaseから会社の非公開GitHubへ安全に取り込み、会社環境で再ビルド・配備する手順を文書化する
...
24. 未認証の画面確認モードで通常入力・見本整理・WBSマッピングを操作でき、業務APIやAsanaへ送信されないことを確認する。
